...
public class ExpoImageOutlineProvider extends ViewOutlineProvider {
  ...
  ExpoImageOutlineProvider(Context context) {
    super();
    mContext = context;
  ...
  boolean setBorderRadius(float radius, int position) {
  ...
  void updateBoundsAndLayoutDirection(View view) {
  ...
  void clipCanvasIfNeeded(Canvas canvas, View view) {
    updateBoundsAndLayoutDirection(view);
    updateCornerRadiiIfNeeded();
    if (!hasEqualCorners()) {
      updateConvexPathIfNeeded();
