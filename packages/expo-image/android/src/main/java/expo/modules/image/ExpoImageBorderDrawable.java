 ...
 */
public class ExpoImageBorderDrawable extends Drawable {
  ...
  public ExpoImageBorderDrawable(Context context) {
    mContext = context;
  }
  ...
  private int getBorderColor(int position) {
    ...
    return ExpoImageBorderDrawable.colorFromAlphaAndRGBComponents(alpha, rgb);
  }
